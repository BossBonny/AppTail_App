...
const Tarea = () => {
    ...
    const { mostrarAlerta, alerta, categorias } = useTareas();
    ...
    const handleUpdate = async () => {
        ...
        try {
            ...
            await clienteAxios.put(`/tareas/tarea/${params}`, { nombre, categoria, prioridad, etiquetas })
    ...
    const eliminarTarea = async () => {
        //Añadir algunas precauciones como modal de confirmacion etc
    ...
    return (
        <ScrollView style={{ padding: 40 }}>
            ...
            <Modal
                ...
                <View style={{ height: 250, width: 300, backgroundColor: 'white', borderRadius: 20, shadowRadius: 4, elevation: 5, alignSelf: 'center', marginTop: 350, alignItems: 'center', padding: 20 }}>
                    <Text style={{ fontSize: 20, fontWeight: '500', textTransform: 'uppercase', marginTop: 30 }}>¿Desea Eliminar {nombre}?</Text>
                    <Text style={{ fontSize: 15, fontWeight: '400', marginVertical: 10, color: 'gray' }}>Sé eliminará para siempre</Text>
                    <View style={{ flexDirection: 'row', marginTop: 30 }}>
                        <Pressable
                            style={{ marginHorizontal: 30 }}
            ...
            {addCategoria &&
                <View style={{ marginBottom: 50 }}>
                    ...
                    <FlatList
                        ...
                        renderItem={({ item }) =>
                            <Pressable
                                style={[cat === item._id && { backgroundColor: 'gray' }, { height: 40, width: 80, borderRadius: 5, borderWidth: 1, margin: 5, justifyContent: 'center' }]}
                                onPress={() => setCat(item._id)}
                            >
            ...
            <Pressable
                style={[actualizado ? { backgroundColor: 'green' } : { backgroundColor: 'black' }, { height: 60, marginVertical: 50, alignItems: 'center', justifyContent: 'center', borderRadius: 20 }]}
